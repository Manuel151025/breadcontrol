...
class PortalClienteController {
    ...
    /**
     * Procesa la notificación automática (webhook) de Wompi.
     */
    public function wompiWebhook() {
        ...
        try {
            ...
            $this->model->procesarWebhookWompi($referencia, $nuevo_estado, $monto_recibido, 'PSE', $tx_id);

            log_error([
                'msg'         => 'Wompi webhook: pago procesado en controlador',
            ...
            log_error(['msg' => 'Wompi webhook: error en controlador', 'error' => $e->getMessage()]);
