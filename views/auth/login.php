...
<style>
    *{margin:0;padding:0;box-sizing:border-box;}
    ...
    .btn-client:hover{background:hsla(30,67%,65%,.1);transform:translateY(-2px);box-shadow:0 8px 30px hsla(30,67%,65%,.15);}
...
<body data-weather-url="<?= htmlspecialchars((string) get_env('API_OPEN_METEO_URL', 'https://api.open-meteo.com/v1/forecast'), ENT_QUOTES) ?>" data-nombre-saludo="<?= htmlspecialchars($nombre_saludo ?? '', ENT_QUOTES) ?>">
  ...
  <form method="POST" class="glass-card" id="login-form">
    ...
    <div class="field">
      ...
      <div class="inp-wrap">
        ...
        <button type="button" class="eye-btn" id="eye-toggle" tabindex="-1" aria-label="Mostrar contraseña">
    ...
    <a href="<?= APP_URL ?>/portal/index.php" class="btn-client">
      <i class="bi bi-person-badge" style="margin-right: .5rem;"></i> Acceso Clientes
    </a>
