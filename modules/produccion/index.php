...
$total_tandas_mes = (float)$pdo->query("SELECT COALESCE(SUM(cantidad_tandas),0) FROM produccion WHERE MONTH(fecha_produccion)=MONTH(CURDATE()) AND YEAR(fecha_produccion)=YEAR(CURDATE())")->fetchColumn();
