...
<style>
  ...
  .inp-unidad-wrap input{flex:1;padding-right:.4rem!important;}
  .inp-unidad-tag{background:rgba(198,113,36,.08);border:1px solid rgba(198,113,36,0.18);border-radius:9px;padding:0 0.75rem;font-size:0.78rem;font-weight:700;color:var(--c3);white-space:nowrap;flex-shrink:0;height:34px;box-sizing:border-box;display:inline-flex;align-items:center;justify-content:center;text-transform:uppercase;}
  /* Ocultar flechas incrementales para evitar recortes de dígitos */
