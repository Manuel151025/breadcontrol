...
if (!empty($_GET['del'])) {
    try { $pdo->prepare("UPDATE producto SET activo=0 WHERE id_producto=?")->execute([(int)$_GET['del']]); } catch (Exception $e) {}
...
<style>
  ...
  .prod-icon{width:36px;height:36px;border-radius:9px;background:linear-gradient(135deg,var(--c3),var(--c1));display:flex;align-items:center;justify-content:center;color:#fff;font-size:.95rem;}
  ...
  .tag-receta{background:rgba(46,125,50,.08);color:#2e7d32;border:1px solid rgba(46,125,50,.2);}
  .tag-noreceta{background:rgba(230,81,0,.08);color:#e65100;border:1px solid rgba(230,81,0,.2);}
  .tag-ing{background:rgba(198,113,36,.08);color:var(--c3);border:1px solid rgba(198,113,36,.2);}
  ...
  .btn-edit{background:rgba(25,118,210,.07);border-color:rgba(25,118,210,.2);color:#1565c0;}.btn-edit:hover{background:rgba(25,118,210,.15);}
  .btn-receta{background:rgba(198,113,36,.07);border-color:rgba(198,113,36,.2);color:var(--c3);}.btn-receta:hover{background:rgba(198,113,36,.15);}
  .btn-del{background:rgba(198,40,40,.07);border-color:rgba(198,40,40,.15);color:#c62828;}.btn-del:hover{background:rgba(198,40,40,.18);}
    ...
    <div class="prod-grid">
      ...
      <div class="prod-card" style="animation-delay:<?= $i * 0.04 ?>s">
        <div style="display:flex;align-items:center;gap:.6rem;">
          <div class="prod-icon"><i class="bi bi-bread-slice"></i></div>
          <div>
        ...
        <div class="prod-tags">
          ...
          <span class="tag tag-ing"><?= $p['num_ingredientes'] ?> ingredientes</span>
          <?php else: ?>
